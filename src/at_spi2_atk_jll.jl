...
if VERSION < v"1.3.0-rc4"
    ...
    error("Unable to import at_spi2_atk_jll on Julia versions older than 1.3!")
end
...
artifacts = Pkg.Artifacts.load_artifacts_toml(artifacts_toml; pkg_uuid=UUID("de012916-1e3f-58c2-8f29-df3ef51d412d"))
...
if best_platform === nothing
    @debug("Unable to load at_spi2_atk; unsupported platform $(triplet(platform_key_abi()))")
else
